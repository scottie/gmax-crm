...
@section('step')
    ...
    <p class="pb-4 text-gray-800">
        Need more help?
        <a class="text-blue-500 hover:underline" href="https://docs.coderprokit.com/installation/installation-on-shared-hosting" target="_blank">See installation guide</a>.
    </p>
