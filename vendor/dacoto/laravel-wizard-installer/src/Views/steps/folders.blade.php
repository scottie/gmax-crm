...
@section('step')
    ...
    <div class="flex justify-end">
        @if(!in_array(false, $checks, true))
            <a href="{{ route('LaravelWizardInstaller::install.database') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-flex items-center">
                Next step
        ...
        @else
            <a href="{{ route('LaravelWizardInstaller::install.folders') }}" class="bg-red-600 hover:bg-red-500 text-white font-bold py-2 px-4 rounded inline-flex items-center">
                Reload
                <svg class="fill-current w-5 h-5 ml-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
